...
list_of_words = [
    ...
    "аквариум", "бумеранг", "виноград", "гороскоп", "дракон",
    "жемчуг", "зонтик", "иволга", "карнавал", "листопад",
    "мандарин", "небоскрёб", "оркестр", "палатка", "ромашка",
    "салфетка", "томат", "ураган", "фейерверк", "холст",
    "цирк", "чайник", "шарф", "щипцы", "эскимо",
    "юрта", "ястреб", "багаж", "вулкан", "гранат",
    "домик", "ёлка", "жук", "звезда", "камень",
    "лодка", "мост", "нота", "остров", "петух",
    "ручей", "свеча", "трактор", "утюг", "фонарь",
    "хлеб", "цветник", "шар", "щупальце", "экран",
    "юбка", "яблоко", "апельсин", "барабан", "ваза"
]
